 ...
 *
 * Owns the WordPress option (`foxelabs_freemius_activation_data`)
 ...
 * single site running multiple Foxe Labs premium plugins only needs
 * one option row.
 *
...
class ActivationRepository {
	...
	/**
	 * Option key that stores activations for all Foxe Labs plugins.
	 *
	 * @since 2.0.0
	 */
	const OPTION_KEY = 'foxelabs_freemius_activation_data';
