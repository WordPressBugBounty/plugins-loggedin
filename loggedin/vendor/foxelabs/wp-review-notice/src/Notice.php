 ...
 * Typical use:
 *
 *   \FoxeLabs\Reviews\Notice::create( 'my-plugin', 'My Plugin' )
 *       ->register();
 *
 ...
 *
 * @link    https://github.com/foxelabs/wp-review-notice
...
namespace FoxeLabs\Reviews;

// If this file is called directly, abort.
defined( 'WPINC' ) || die;

use FoxeLabs\Reviews\Contracts\CapabilityCheckerInterface;
use FoxeLabs\Reviews\Contracts\DismissalStoreInterface;
use FoxeLabs\Reviews\Contracts\RendererInterface;
use FoxeLabs\Reviews\Contracts\ScreenResolverInterface;
use FoxeLabs\Reviews\Contracts\TimerStoreInterface;
use FoxeLabs\Reviews\Rendering\DefaultRenderer;
use FoxeLabs\Reviews\Storage\AdminScreenResolver;
use FoxeLabs\Reviews\Storage\SiteOptionTimerStore;
use FoxeLabs\Reviews\Storage\UserMetaDismissalStore;
use FoxeLabs\Reviews\Storage\WordPressCapabilityChecker;
use FoxeLabs\Reviews\Support\ActionRouter;
use FoxeLabs\Reviews\Support\Config;
use FoxeLabs\Reviews\Support\KeyPrefixer;
