 ...
 * {@see \FoxeLabs\Reviews\Support\KeyPrefixer} with an empty prefix or
 * building a {@see \FoxeLabs\Reviews\Support\Config} without the
...
namespace FoxeLabs\Reviews\Exceptions;
